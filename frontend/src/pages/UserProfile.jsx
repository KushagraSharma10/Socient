    ...
    return (
        <div className="max-w-4xl mx-auto p-4 mt-5">
            ...
            <div className="mt-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                    {user.posts.map((post, index) => (
                        <div key={index} className="w-full h-64 bg-gray-100">
                            {post.images.length > 1 ? (
                                ...
                                >
                                    ...
                                    <div className={`prev-${index} absolute top-1/2 left-2 transform -translate-y-1/2 cursor-pointer z-10`}>
                                        <FaChevronLeft className="text-white text-xl" />
                                    </div>
                                    <div className={`next-${index} absolute top-1/2 right-2 transform -translate-y-1/2 cursor-pointer z-10`}>
