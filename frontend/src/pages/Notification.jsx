...
//     return (
//         <div className="min-h-screen bg-gradient-to-br from-gray-100 via-blue-50 to-gray-200 flex flex-col items-center p-6">
//             <div className="w-full max-w-4xl bg-white shadow-lg rounded-xl p-8">
//                 <h2 className="text-4xl font-extrabold mb-6 text-gray-900 border-b-2 pb-4">
//                     Notifications
//                 </h2>
...
//                             <p className="text-gray-500 text-center italic">You have no new notifications.</p>
//                         ) : (
//                             notifications.map((notification) => (
//                                 <li
//                                     key={notification._id}
//                                     className="flex items-center justify-between bg-gray-50 border border-gray-200 rounded-lg shadow-md p-6 hover:bg-gray-100 transition-all duration-300"
//                                 >
...
//                                                 <span className="font-bold text-blue-600">{notification.sender.username}</span>{' '}
...
//                                         </div>
//                                     </div>
//                                     <span className={`px-3 py-1 text-xs font-semibold rounded-lg shadow-md 
//                                         ${notification.type === 'follow' ? 'bg-blue-100 text-blue-600' : 'bg-green-100 text-green-600'}`}
//                                     >
                                ...
                                >
                                    ...
                                    {notification.type === 'requested' ? (
                                        <div className="flex space-x-2">
                                            ...
                                            <button
                                                onClick={() =>
                                                    handleRejectRequest(notification._id, notification.sender._id)
                                                }
